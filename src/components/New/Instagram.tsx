        ...
        <>
            <div className="instagram-block md:pt-20 pt-10">
                <div className="heading">
                    <div className="heading3 text-center">{t("Mal Al Sham Furniture On Instagram")}</div>
                    <div className="text-center mt-3">#{t("Anvougetheme")}</div>
                </div>
