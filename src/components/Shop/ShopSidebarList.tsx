...
const HandlePagination: React.FC<PaginationProps> = ({
  ...
  return (
    <ReactPaginate
      ...
      nextClassName="mx-1"
      previousLinkClassName="px-3 py-1 rounded bg-gray-200 hover:bg-gray-300 rotateSvg"
      nextLinkClassName="px-3 py-1 rounded bg-gray-200 hover:bg-gray-300 rotateSvg"
                  ...
                  <div className="min flex-1">
                    ...
                    <div className="relative rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        className="focus:ring-primary-500 focus:border-primary-500 block w-full ps-7 pe-4 py-2 sm:text-sm border-gray-300 rounded-md"
                        placeholder="0"
                        min="0"
                      />
                    </div>
                  ...
                  <div className="max flex-1">
                    ...
                    <div className="relative rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        className="focus:ring-primary-500 border focus:border-primary-500 block w-full ps-7 pe-4 py-2 sm:text-sm border-gray-300 rounded-md"
                        placeholder="10000"
                        min="0"
                      />
                    </div>
              ...
              {productName && (
                <div className="mb-4 text-lg">
                  ...
                  <button
                    ...
                    className="ms-2 text-blue-500 hover:underline text-sm"
                  >
                    {t('shop.clearSearch')}
                  </button>
                </div>
