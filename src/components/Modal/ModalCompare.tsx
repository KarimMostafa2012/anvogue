                ...
                >
                    ...
                    <div className="container h-full flex items-center w-full">
                        <div className="content-main flex items-center justify-between xl:gap-10 gap-6 w-full max-md:flex-wrap">
                            <div className="heading5 flex-shrink-0 max-md:w-full">{t("Compare Products")}</div>
                                    ...
                                    <div key={product.id} className='item p-3 border border-line rounded-xl relative'>
                                        <div className="infor flex items-center gap-4">
                                            ...
                                            <div className=''>
                                                ...
                                                <div className="product-price text-title mt-2">${product.price}</div>
                                            </div>
                                        </div>
                                    ...
                                    compareState.compareArray.length < 2 ? (
                                        <>
                                            <a
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation()
                                                    alert(t("Minimum 2 products required to compare!"))
                                                }}
                                            >
                                                {t("Compare Products")}
                                            </a>
                                        ...
                                        <>
                                            <Link href={'/compare'} onClick={closeModalCompare} className='button-main whitespace-nowrap'>{t("Compare Products")}</Link>
                                        </>
                                    )
                                }
                                <div
