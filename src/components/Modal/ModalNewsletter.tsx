                ...
                >
                    <div className="main-content flex rounded-[20px] overflow-hidden w-full">
                        <div
                            ...
                            <div className="text-xs font-semibold uppercase text-center">{t('modal.newsletter.specialOffer')}</div>
                            <div
                                className="lg:text-[70px] text-4xl lg:leading-[78px] leading-[42px] font-bold uppercase text-center">
                                {t('modal.newsletter.blackFridays')}</div>
                            <div className="text-button-uppercase text-center">{t('modal.newsletter.newCustomersSave')} <span
                                className="text-red">30%</span>
                                {t('modal.newsletter.withCode')}</div>
                            <div className="text-button-uppercase text-red bg-white py-2 px-4 rounded-lg">GET20off</div>
                            <div className="button-main w-fit bg-black text-white hover:bg-white uppercase">{t('modal.newsletter.copyCouponCode')}
                            </div>
                        </div>
                        <div className="right lg:w-1/2 sm:w-3/5 w-full bg-white sm:pt-10 sm:pl-10 max-sm:p-6 relative">
                            ...
                            <div className="heading5 pb-5">{t('modal.newsletter.youMayAlsoLike')}</div>
                                            ...
                                            >
                                                ...
                                                <div className=''>
                                                    ...
                                                    <div className="flex items-center gap-2 mt-2">
                                                        <div className="product-price text-title">${item.new_price}.00</div>
