            ...
            <div className={`modal-sizeguide-block`} onClick={onClose}>
                ...
                >
                    ...
                    <div className="md:mt-8 mt-6 progress">
                        <div className="flex imd:items-center gap-10 justify-between max-md:flex-col gap-y-5 max-md:pe-3">
                        ...
                        <div className="flex md:items-center gap-10 justify-between max-md:flex-col gap-y-5 max-md:pe-3 mt-5">
